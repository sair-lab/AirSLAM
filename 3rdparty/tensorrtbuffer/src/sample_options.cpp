...
//! If it does not: return false.
    ...
    void BuildOptions::parse(Arguments& arguments)
    {
        ...
        {
            tensorrt_log::gLogWarning << "--buildOnly flag has been deprecated by --skipInference flag." << std::endl;
        }
        ...
        {
            tensorrt_log::gLogWarning << R"(When --precisionConstraints flag is set to "obey" or "prefer", please add )"
        ...
        {
            tensorrt_log::gLogWarning << "--heuristic flag has been deprecated, use --builderOptimizationLevel=<N> flag instead "
        ...
        else if (tensorrt_buffer::toLower(hardwareCompatibleArgs) == "ampere+")
        {
        ...
        if ((useRuntime == RuntimeMode::kDISPATCH || useRuntime == RuntimeMode::kLEAN) && !versionCompatible)
        {
            ...
            tensorrt_log::gLogWarning << "Implicitly enabling --versionCompatible since --useRuntime=" << runtimeMode
                                << " is set." << std::endl;
        }
    ...
    void SystemOptions::parse(Arguments& arguments)
    {
        ...
        {
            tensorrt_log::gLogWarning << "--plugins flag has been deprecated, use --staticPlugins flag instead." << std::endl;
    ...
    void InferenceOptions::parse(Arguments& arguments)
    {
        ...
        {
            tensorrt_log::gLogWarning << "--streams flag has been deprecated, use --infStreams flag instead." << std::endl;
        }
